...
train_data_source = '1.csv'
test_data_source = '1test.csv'
...
# Output Layer
predictions = Dense(num_of_classes, activation='softmax',kernel_regularizer=l2(0.01), bias_regularizer=l2(0.01))(x)
# Build model
model = Model(inputs=inputs, outputs=predictions)
model.compile(optimizer=optimizer, loss=loss, metrics=['accuracy'])  # Adam, categorical_crossentropy
model.summary()
model=load_model('tone.h5')
# Shuffle
